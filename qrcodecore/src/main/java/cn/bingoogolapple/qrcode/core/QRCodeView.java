...
public abstract class QRCodeView extends RelativeLayout implements Camera.PreviewCallback, ScanBoxView.FlashTouchListener {
    /**
     * 识别的最小延时，避免相机还未初始化完成
     */
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mScanBoxView.setFlashTouchListener(this);
...
//        addView(mScanBoxView, layoutParams);
        ...
        layoutParams1.addRule(RelativeLayout.ALIGN_TOP, mCameraPreview.getId());
        layoutParams1.addRule(RelativeLayout.ALIGN_BOTTOM, mCameraPreview.getId());


        mScanBoxView.setLayoutParams(layoutParams1);
